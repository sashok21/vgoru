# Generated migration — початковий стан схеми бази даних.
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(
                    choices=[('easy', 'Легка'), ('medium', 'Середня'), ('hard', 'Важка')],
                    max_length=10,
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='routes/', verbose_name='Основне фото')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('completed_routes', models.ManyToManyField(
                    blank=True,
                    related_name='completed_by',
                    to='mountains_roads.mountainroute',
                    verbose_name='Пройдені маршрути',
                )),
                ('favorite_routes', models.ManyToManyField(
                    blank=True,
                    related_name='favorited_by',
                    to='mountains_roads.mountainroute',
                    verbose_name='Улюблені маршрути',
                )),

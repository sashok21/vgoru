...
class MountainRoute(models.Model):
    ...
    gpx_file = models.FileField(
        ...
        null=True,
        blank=True,
        verbose_name='GPX файл маршруту',
    )
    ...
    def get_absolute_url(self):
        return reverse('mountains_roads:route-detail', kwargs={'pk': self.pk})
...
class RouteReview(models.Model):
    ...
    def __str__(self):
        return f'Відгук {self.user.username} — {self.route.name}'
...
class UserProfile(models.Model):
    ...
    def favorites_count(self):
        return self.favorite_routes.count()
